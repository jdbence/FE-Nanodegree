...
adjective.whimsy = ["whimsical", "silly", "drunken", "goofy", "funny", "weird", "strange", "odd", "playful", "clever", "boastful", "breakdancing",
...
adjective.scientific = ["scientific", "technical", "digital", "programming", "calculating", "formulating", "cyberpunk", "mechanical", "technological",
  ...
  "extinct", "galactic"];
adjective.scifi_default = ["scientific", "technical", "digital", "programming", "calculating", "formulating", "cyberpunk", "mechanical", "technological",
  "innovative", "brainy", "chemical", "quantum", "astro", "space", "theoretical", "atomic", "electronic", "gaseous", "investigative", "solar",
  "extinct", "galactic"];
var noun = {};
...
noun.professions = ["doctor", "lawyer", "ninja", "writer", "samurai", "surgeon", "clerk", "artist", "actor", "engineer", "mechanic",
...
noun.music = ["violin", "flute", "bagpipe", "guitar", "symphony", "orchestra", "piano", "trombone", "tuba", "opera", "drums",
...
noun.scifi_default = ["robot", "alien", "raygun", "spaceship", "UFO", "rocket", "phaser", "astronaut", "spaceman", "planet", "star", "galaxy",
  "computer", "future", "timeMachine", "wormHole", "timeTraveler", "scientist", "invention", "martian", "pluto", "jupiter", "saturn", "mars",
  "quasar", "blackHole", "warpDrive", "laser", "orbit", "gears", "molecule", "electron", "neutrino", "proton", "experiment", "photon", "apparatus",
  "universe", "gravity", "darkMatter", "constellation", "circuit", "asteroid"];
...
var resizePizzas = function(size) {
  ...
  function changeSliderLabel(size) {
    var pizzaSize = (document.getElementsByClassName("pizzaSize")[0]);
    switch(size) {
      case "1":
  ...
  function changePizzaSizes(size) {
    var windowWidth = (document.getElementsByClassName("randomPizzas")[0]).offsetWidth;
    var pizzaContainerElements = document.getElementsByClassName("randomPizzaContainer");
    var pizzaContainer;
    var newwidth = windowWidth * (size === "1" ? 0.25 : size === "2" ? 0.3333 : 0.5);
    var totalPizzas = pizzaContainerElements.length;
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Uses frag to append to DOM only once
  var frag = document.createDocumentFragment();
  var totalPizzas = (window.screen.height / s | 0) * cols;
  for (var i = 0; i < totalPizzas; i++) {
